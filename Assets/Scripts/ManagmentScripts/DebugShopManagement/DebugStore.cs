...
public class DebugStore : MonoBehaviour
{
	...
	public string gamePlayDataName = "/gamePlayData.txt";
    public string debugStoreDataName = "/debugStoreData.txt";
    ...
    void Start()
    {
        ...
        gamePlayDataName = HTMLPlatformUtil.GetSavePath() + gamePlayDataName;
        debugStoreDataName = HTMLPlatformUtil.GetSavePath() + debugStoreDataName;
  //      print($"{HTMLPlatformUtil.GetSavePath()}");
		//print($"{gamePlaySaveData}");
		LoadCandyData();
    ...
    public void SaveCandyData()
    {
        ...
        {
            File.WriteAllText(gamePlayDataName, json);
        }
    }
    ...
    public void LoadCandyData()
    {
        ...
        {
            if (!File.Exists(gamePlayDataName))
            {
                Debug.Log("Candy data file not found, creating default.");
                SaveCandyData();
            }

            saveString = File.ReadAllText(gamePlayDataName);
        }
    ...
    public void DeleteDataLogic()
    {
        ...
        else
        {
            if (File.Exists(gamePlayDataName))
            {
                File.Delete(gamePlayDataName);
                debugStatsLocal = null;
                print("Deleted save candyData");
            }

            if (File.Exists(debugStoreDataName))
            {
                File.Delete(debugStoreDataName);
                shopItemCollectionLocal = null;
    ...
    public void SaveAllButtons()
    {
        ...
        {
            File.WriteAllText(debugStoreDataName, json);
        }
    }
    ...
    public void LoadButtonData()
    {
        ...
        else
        {
            ...
            saveString = File.ReadAllText(debugStoreDataName);
        }
